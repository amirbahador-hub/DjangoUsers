    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spoiled_delta', models.DurationField(default=datetime.timedelta(days=15))),
            ],
        ),
        migrations.CreateModel(
            name='Store',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='IRR', max_digits=14)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accessitem.product')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accessitem.store')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='stores',
            field=models.ManyToManyField(through='accessitem.ProductStore', to='accessitem.Store'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('replied_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accessitem.comment')),
            ],
        ),
    ]
